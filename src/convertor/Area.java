 ...
 * Area.java
 *
 * Created on Jul 2, 2014, 4:00:05 PM
 */
package convertor;
...
public class Area extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "square_cm", "square_m", "Acres", "Hectares", " " }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "square_cm", "square_m", "Acres", "Hectares", " " }));
...
// TODO add your handling code here:
    ...
    if(obj2.equals("square_m")){
        res = obj1*4046.8564224;
        jTextField2.setText(String.valueOf(res));
       }
    if(obj2.equals("square_cm")){
        res1 = obj1*40468564.224;
        jTextField2.setText(String.valueOf(res1));
   }
    if(obj2.equals("Hectares")){
        res2 = obj1*(1/2.4710538147);
        jTextField2.setText(String.valueOf(res2));
   }
  }
      if(obj.equals("Hectares")){
    obj1 = Double.parseDouble(jTextField1.getText());
    obj2 = jComboBox2.getSelectedItem().toString();
    if(obj2.equals("Hectares")){
        jTextField2.setText(jTextField1.getText());
