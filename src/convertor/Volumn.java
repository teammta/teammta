 ...
 * Volumn.java
 *
 * Created on Jul 2, 2014, 4:00:39 PM
 */
package convertor;
 ...
 * @author Ayon
 */
public class Volumn extends javax.swing.JFrame {
    private String obj;
    private double obj1;
    private String obj2;
    private double res;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "cubic_cm", "cubic_m", "Gallons", "Litres" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "cubic_cm", "cubic_m", "Gallons", "Litres" }));
...
// TODO add your handling code here:
    ...
    if(obj.equals("cubic_cm")){
    obj1 = Double.parseDouble(jTextField1.getText());
    obj2 = jComboBox2.getSelectedItem().toString();
    if(obj2.equals("cubic_cm")){
        jTextField2.setText(jTextField1.getText());
       }
    if(obj2.equals("cubic_m")){
        res = obj1*(1/1000000);
        jTextField2.setText(String.valueOf(res));
       }
    if(obj2.equals("Gallons")){
        res1 = obj1*(1/4546.09);
        jTextField2.setText(String.valueOf(res1));
   }
    if(obj2.equals("Litres")){
        res2 = obj1*(1/100000000);
        jTextField2.setText(String.valueOf(res2));
   }
  }
    if(obj.equals("cubic_m")){
    obj1 = Double.parseDouble(jTextField1.getText());
    obj2 = jComboBox2.getSelectedItem().toString();
    if(obj2.equals("cubic_m")){
        jTextField2.setText(jTextField1.getText());
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Volumn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
